const lyTop = {
            ...
            <div class='py-container'> \
                <div class='yui3-g Logo'> \
                    <div class='yui3-u Left logoArea'> \
                        <a class='logo-bd' title='乐优' href='/index.html'></a> \
                    </div> \
                        ...
                        <div class='search'> \
                            <form action='' class='sui-form form-inline'> \
                                ...
                                <div class='input-append'> \
                                    <input type='text' id='autocomplete'  placeholder='小米手机' v-model='key' \
    ...
    created() {
        this.key = this.getUrlParam("key")==null ? "小米手机":this.getUrlParam("key");
    },
    components: {
